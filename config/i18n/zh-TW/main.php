...
return array(
    ...
    "forget_password_tips"           => "管理員忘記密碼: <br/>請登錄服務器刪除<b>./data/system/install.lock</b>後重置; <br/><br/>非管理員忘記密碼: <br/>請聯繫管理員重置！",
    ...
    "need_check_code_desc"           => "開啟後登錄必須需要輸入驗證碼,遊客自動登錄將失效.",
    ...
    "Plugin.config.authOpenDesc"     => "無需登錄皆可訪問,可用於對外接口調用",
